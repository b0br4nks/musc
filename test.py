...
def test(folder: str):
    ...
    for entry in os.scandir(folder):
        ...
        if entry.is_file() and entry.path.endswith(skorpio_ext):
            ...
            sim_cmd = cmd_run_echoed([sys.executable, "./skorpio.py", "-I", folder, "-s", entry.path], capture_output=True)
            ...
            com_cmd = cmd_run_echoed([sys.executable, "./skorpio.py", "-I", folder, "-c", "-r", "--silent", entry.path], capture_output=True)
